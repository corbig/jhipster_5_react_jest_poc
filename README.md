...
## This project is a POC of Karma to Jest migration based on a dedicated Jhipster module (not publicly available at the moment).
...
To optimize the test_react application for production, run:
